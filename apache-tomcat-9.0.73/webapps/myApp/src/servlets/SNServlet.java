...
public class SNServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<h2>Functions and parameters they require:</h2>");
        out.println("<ul>");
        out.println("<li>newPage(user_id, email, page_title, page_pic)</li>");
        out.println("<ul>");
        out.println("<li>User ID</li>");
        out.println("<li>Email</li>");
        out.println("<li>Page Title</li>");
        out.println("<li>Page Picture</li>");
        out.println("</ul>");
        out.println("<li>getPage(page_id)</li>");
        out.println("<ul>");
        out.println("<li>Page ID</li>");
        out.println("</ul>");
        out.println("<li>deletePage(page_id)</li>");
        out.println("<ul>");
        out.println("<li>Page ID</li>");
        out.println("</ul>");
        out.println("<li>followrequest(followed_page_id, follower_page_id)</li>");
        out.println("<ul>");
        out.println("<li>Followed Page ID</li>");
        out.println("</ul>");
        out.println("<li>newPost(page_id, post_date, post_text)</li>");
        out.println("<ul>");
        out.println("<li>Page ID</li>");
        out.println("<li>Post Date</li>");
        out.println("<li>Post Text</li>");
        out.println("</ul>");
        out.println("<li>getPost(post_id)</li>");
        out.println("<ul>");
        out.println("<li>Post ID</li>");
        out.println("</ul>");
        out.println("<li>deletePost(post_id)</li>");
        out.println("<ul>");
        out.println("<li>Post ID</li>");
        out.println("</ul>");
        out.println("<li>like(liked_page_id, post_id, liker_page_id)</li>");
        out.println("<ul>");
        out.println("<li>Liked Page ID</li>");
        out.println("<li>Post ID</li>");
        out.println("<li>Liker Page ID</li>");
        out.println("</ul>");
        out.println("<li>getPages()</li>");
        out.println("<li>getPosts(page_id)</li>");
        out.println("<ul>");
        out.println("<li>Page ID</li>");
        out.println("</ul>");
        out.println("<li>getFollowers(page_id)</li>");
        out.println("<ul>");
        out.println("<li>Page ID</li>");
        out.println("</ul>");
        out.println("<li>getLikes(post_id)</li>");
        out.println("<ul>");
        out.println("<li>Page ID</li>");
        out.println("<li>Post ID</li>");
        out.println("</ul>");
